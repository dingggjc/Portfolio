            ...
            <CardContent className="flex items-center justify-between p-6">
              <div className="flex items-center gap-6">
                <div className="flex size-14 items-center justify-center rounded-2xl bg-primary/20 text-primary shadow-inner">
                  <SunIcon className="size-8 animate-pulse" />
                </div>
                <div>
                  ...
                  <h2 className="text-3xl font-black tabular-nums">
                    32°C
                    <span className="ml-1 text-lg font-medium text-muted-foreground italic">
                      Sunny
                    </span>
                  </h2>
                </div>
              </div>
              <div className="hidden border-l border-primary/10 pl-8 @[600px]/main:block">
